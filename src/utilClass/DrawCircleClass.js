import { circleDraw, computePointInCanvas } from "../utils/drawFunction";

export class DrawCircleClass {
  constructor(
    canvasRef,
    startPoint,
    isDraw,
  ...
  mouseMove(event) {
    ...
    if (this.isDraw && this.snapshot) {
      ...
      circleDraw(this.canvasRef, this.startPoint, event.clientX, event.clientY);
    }
  }
